...
namespace BrightstarDB.Storage.BTree
{
    internal class LeafNode : ILeafNode
    {
        ...
        public LeafNode(PageStruct reservedPage, ulong prevPointer, ulong nextPointer,
        ...
        public LeafNode(PageStruct page, int keyCount, BPlusTreeConfiguration treeConfiguration)
        {
            _page = page;
            _keyCount = keyCount;
        ...
        public LeafNode(PageStruct page, ulong prevPointer, ulong nextPointer,
                              BPlusTreeConfiguration treeConfiguration,
        ...
        public bool Merge(WriteablePageStoreSession session, INode s)
        {
...
_config.BTreeDebug("LeafNode.Insert@{0}. Key={1}. Updated Node: {2}",PageId, key.Dump(), DumpKeys());
        ...
        public ILeafNode Split(WriteablePageStoreSession session, PageStruct rightNodePage, out byte[] splitKey)
        {
            Next = rightNodePage.PageNumber;
...
_config.BTreeDebug("LeafNode.Split@{0}. Keys after: {1}", PageId, DumpKeys());
        ...
        public bool RedistributeFromLeft(WriteablePageStoreSession session, ILeafNode leftNode)
        {
        ...
        public bool RedistributeFromRight(WriteablePageStoreSession session, ILeafNode rightNode)
        {
