...
namespace BrightstarDB.Storage.BTree
{
    internal interface IInternalNode : INode
    {
        ...
        bool Merge(WriteablePageStoreSession txnId, INode s, byte[] joinKey);
        ...
        IInternalNode Split(WriteablePageStoreSession txnId, PageStruct rightNodePage, out byte[] splitKey);
        ...
        void Insert(WriteablePageStoreSession txnId, byte[] key, ulong childPointer);
        ...
        void UpdateChildPointer(WriteablePageStoreSession txnId, ulong oldChildPointer, ulong newChildPointer);
        ...
        bool RedistributeFromLeft(WriteablePageStoreSession txnId, IInternalNode leftSibling, byte[] joinKey, byte[] newJoinKey);

        bool RedistributeFromRight(WriteablePageStoreSession txnId, IInternalNode rightSibling, byte[] joinKey, byte [] newJoinKey);
        ...
        void SetLeftKey(WriteablePageStoreSession txnId, ulong childNodeId, byte[] childNodeKey);

        byte[] GetKey(ulong childNodeId);

        void SetKey(WriteablePageStoreSession txnId, ulong childNodeId, byte[] newKey);
        ...
        byte[] RemoveChildPointer(WriteablePageStoreSession txnId, ulong childNodeId);
