...
namespace BrightstarDB.Storage.BTree
{
    internal interface ILeafNode : INode
    {
        ...
        bool Merge(WriteablePageStoreSession txnId, INode s);
        ...
        void Insert(WriteablePageStoreSession txnId, byte[] key, byte[] value, bool overwrite = false);
        ...
        ILeafNode Split(WriteablePageStoreSession txnId, PageStruct newNodePage , out byte[] splitKey);
        ...
        void Delete(WriteablePageStoreSession txnId, byte[] key);
        ...
        bool RedistributeFromLeft(WriteablePageStoreSession txnId, ILeafNode leftNode);
        ...
        /// <returns>True if the node achieves its minimum size by the redistribution process, false otherwise</returns>
        bool RedistributeFromRight(WriteablePageStoreSession txnId, ILeafNode rightNode);
